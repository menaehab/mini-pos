                        ...
                        <div className="grid grid-cols-1 items-end gap-8 p-6 md:grid-cols-2">
                            ...
                            <div className="flex flex-col gap-2 border-r border-gray-100 md:border-l md:border-r-0 md:pl-8">
                                ...
                                <div className="flex w-full items-center justify-between rounded-full border border-gray-200 bg-white p-1 shadow-sm">
                                    ...
                                    <button
                                        type="button"
                                        onClick={() => setData('payment_method', 'installments')}
                    ...
                    <div className="flex flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
                        ...
                        <div className="p-6">
                            {data.items.map((item, index) => {
                                const productError = errors[`items.${index}.product_id`];
                                const costError = errors[`items.${index}.cost_price`];
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex flex-col gap-2">
                                            <label className="flex justify-start text-sm font-semibold text-gray-800">
                                                <span className="ml-1 text-red-500">*</span> منتج
                                            </label>
                                            <div className="relative">
                                                <select
                                                ...
                                                <ChevronDown className="absolute left-4 top-3.5 text-gray-400" size={18} />
                                            </div>
                                        </div>

                                        <div className="flex flex-col gap-2">
                                            <label className="flex justify-start text-sm font-semibold text-gray-800">
                                                <span className="ml-1 text-red-500">*</span> سعر التكلفة
                                            </label>
                                            <input
                                                type="number"
                                                min="0"
                                                ...
                                                className={`w-full rounded-xl border ${costError ? 'border-red-500' : 'border-gray-200'} px-4 py-3 text-center text-sm focus:border-black focus:outline-none`}
                                            />
                                        </div>

                                        <div className="flex flex-col gap-2">
                                            <label className="flex justify-start text-sm font-semibold text-gray-800">
                                                <span className="ml-1 text-red-500">*</span> الكمية
                                            </label>
                                            <input
                                                type="number"
                                                min="1"
                        ...
                        <div className="flex justify-end border-t border-gray-50 p-6">
                            <div className="flex w-fit items-center gap-8 rounded-2xl bg-[#f3f4f6] px-6 py-4">
                                ...
                                <button
                                    type="submit"
                                    disabled={processing || data.items.some(i => !i.product_id || !i.cost_price || !i.quantity)}

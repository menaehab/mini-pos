...
export default function Create({ suppliers = [], products = [] }) {
    ...
    const handleItemChange = (index, field, value) => {
        ...
        if (field === 'product_id') {
            ...
            newItems[index].item_name = selectedProduct?.name ?? '';

            if (selectedProduct && !newItems[index].purchase_price) {
                newItems[index].purchase_price = selectedProduct.purchase_price;
            }

            if (selectedProduct && !newItems[index].sale_price) {
                newItems[index].sale_price = selectedProduct.sale_price;
            }
        }
